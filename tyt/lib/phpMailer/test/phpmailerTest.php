...
require_once '../../control3/PHPMailer-master/PHPMailerAutoload.php';
...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        if (file_exists('../../control3/PHPMailer-master/test/testbootstrap.php')) {
            include '../../control3/PHPMailer-master/test/testbootstrap.php'; //Overrides go in here
        }
...
EOT;
    ...
    public function testIcal()
    {
        ...
        $this->Mail->isHTML(true);
        $this->buildBody();
        require_once '../../control3/PHPMailer-master/extras/EasyPeasyICS.php';
